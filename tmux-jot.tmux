...
jot_bind_mode "resize_increase" "$RESIZE_INCREASE_BIND" "$RESIZE_INCREASE_REPEAT_BIND"
jot_bind_mode "resize_decrease" "$RESIZE_DECREASE_BIND" "$RESIZE_DECREASE_REPEAT_BIND"
